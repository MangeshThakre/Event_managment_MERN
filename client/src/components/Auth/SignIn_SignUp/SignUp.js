...
function SignUp() {
  ...
  async function handleSubmit(e) {
    ...
    if (formData.password !== formData.confirmPassword) {
      return notify("password and confirm password not match", "error");
    }
  ...
  return (
    <form className="space-y-4" onSubmit={(e) => handleSubmit(e)}>
      ...
      <button
        type="submit"
        className="w-full  flex   justify-center text-white bg-[#283895] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-lg text-sm px-5 py-2.5 text-center"
      >
        Sign Up
        {signUpLoading ? (
          <svg
